...
- Ensure you target a BITE‑enabled FAIR RPC endpoint.
- If decryption data is not available yet, the transaction may not be finalized; poll after confirmation.
- For local testing, consult the repo scripts to run a node and SGX simulator.
